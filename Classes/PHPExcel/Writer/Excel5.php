...
class PHPExcel_Writer_Excel5 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
 ...
 private readonly PHPExcel $_phpExcel) {
	...
	public function save($pFilename = null) {
		...
		$this->_writerWorkbook = new PHPExcel_Writer_Excel5_Workbook($this->_str_total, $this->_str_unique, $this->_str_table,
																	 $this->_colors, $this->_parser, $this->_phpExcel);
	...
	private function _writeDocumentSummaryInformation(){
      ...
      'data'	=> ['data' => 1252],
		...
		if($this->_phpExcel->getProperties()->getCategory()){
			...
			$dataSection[] = ['summary'=> ['pack' => 'V', 'data' => 0x02], 'offset' => ['pack' => 'V'], 'type' 	=> ['pack' => 'V', 'data' => 0x1E], 'data'	=> ['data' => $dataProp, 'length' => strlen((string) $dataProp)]];
			$dataSection_NumProps++;
		}
